...
public class ColumnsViewRecord extends TableRecordImpl<ColumnsViewRecord> {
     ...
     * Create a detached, initialised TableColumnsViewRecord
     */
    public ColumnsViewRecord(ColumnsView value) {
        super(ColumnsViewTable.COLUMNS_VIEW);
